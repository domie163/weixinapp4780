  ...
  <div :style='{"padding":"30px","background":""}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yisheng'"  label="医生编号" prop="yishengbianhao">
          <el-input v-model="ruleForm.yishengbianhao" readonly              placeholder="医生编号" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='yisheng'"  label="科室名称" prop="keshimingcheng">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='yisheng'" label="科室图片" prop="keshitupian">
          <file-upload
          tip="点击上传科室图片"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.yishengbianhao)&& 'yisheng'==this.flag){
