	...
	<div class="addEdit-block" :style='{"padding":"30px","background":""}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="主治功能" prop="zhuzhigongneng">
					<el-input v-model="ruleForm.zhuzhigongneng" placeholder="主治功能" clearable  :readonly="ro.zhuzhigongneng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="主治功能" prop="zhuzhigongneng">
					<el-input v-model="ruleForm.zhuzhigongneng" placeholder="主治功能" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="用法用量" prop="yongfayongliang">
					<el-input v-model="ruleForm.yongfayongliang" placeholder="用法用量" clearable  :readonly="ro.yongfayongliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="用法用量" prop="yongfayongliang">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
                    <span :style='{"border":"1px solid #5497f2","padding":"0 40px","color":"#bbbbbb","borderRadius":"20px 40px","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.zhuyishixiang"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhuzhigongneng'){
							this.ruleForm.zhuzhigongneng = obj[o];
							this.ro.zhuzhigongneng = true;
							continue;
						}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../django0d26l/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
