	...
	<div class="addEdit-block" :style='{"padding":"30px","background":""}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="提醒类型" prop="tixingleixing">
					<el-input v-model="ruleForm.tixingleixing" placeholder="提醒类型" clearable  :readonly="ro.tixingleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="提醒类型" prop="tixingleixing">
					<el-input v-model="ruleForm.tixingleixing" placeholder="提醒类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.tixingtupian" label="提醒图片" prop="tixingtupian">
					<file-upload
						tip="点击上传提醒图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.tixingtupian" label="提醒图片" prop="tixingtupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.tixingneirong" label="提醒内容" prop="tixingneirong">
                    <span :style='{"border":"1px solid #5497f2","padding":"0 40px","color":"#bbbbbb","borderRadius":"20px 40px","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.tixingneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tixingneirong = this.ruleForm.tixingneirong.replace(reg,'../../../django0d26l/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
