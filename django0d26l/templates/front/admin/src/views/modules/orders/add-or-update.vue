		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.logistics" label="物流" prop="logistics">
                    <span :style='{"border":"1px solid #5497f2","padding":"0 40px","color":"#bbbbbb","borderRadius":"20px 40px","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.logistics"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../django0d26l/upload');
        } else {
