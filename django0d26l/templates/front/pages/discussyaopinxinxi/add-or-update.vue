	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussyaopinxinxi`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discussyaopinxinxi`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discussyaopinxinxi`, this.ruleForm);
						}else{
							await this.$api.add(`discussyaopinxinxi`, this.ruleForm);
						}
						uni.setStorageSync('discussyaopinxinxiCleanType',true);
